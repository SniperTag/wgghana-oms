...
<body>
                    ...
                    <div class="block-content block-content-full">
                        <div class="mb-4">
                            <div class="form-check">
                                ...
                                <label class="form-check-label fw-medium"
                                    for="side-overlay-settings-security-status">Online Status</label>
                        ...
                        <div class="mb-4">
                            <div class="form-check">
                                ...
                                <label class="form-check-label fw-medium"
                                    for="side-overlay-settings-security-verify">Verify on Login</label>
                        ...
                        <div class="mb-4">
                            <div class="form-check">
                                ...
                                <label class="form-check-label fw-medium"
                                    for="side-overlay-settings-security-updates">Auto Updates</label>
    ...
    @fluxScripts
    @include('partials.externalauth-js')

...
class SupervisorController extends Controller
{
    ...
    if ($annualLeaveType) {
        ...
        return view('supervisor.leaves.create', compact(
            ...
            'onLeaveCount', 'leaveBalance', 'totalAnnualLeaveCount','leaveTypes','annualLeaveType', 'user'
        ));
    }
    ...
    public function attendance()
    {
        ...
        return view('supervisor.attendance', compact('attendanceRecords'));
    }

    // Function to show the leave index page
   public function index()
{
    ...
    return view('supervisor.leaves.index', compact(
        'leaves',
        'pendingCount', 'approvedCount', 'rejectedCount',
        'onLeaveCount', 'leaveBalance', 'totalAnnualLeaveCount'
    ));
}

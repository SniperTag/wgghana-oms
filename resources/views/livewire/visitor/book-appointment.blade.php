    ...
    <div class="relative z-10 max-w-4xl mx-auto">
        ...
        @if ($step === 2)
            <div class="bg-white bg-opacity-90 p-8 rounded-lg shadow-lg">
                ...
                <form wire:submit.prevent="submit" class="space-y-4">
                    <input wire:model="visitor_name" type="text" class="form-control" placeholder="Visitor Name"
                        readonly>
                    <input wire:model="visitor_email" type="email" class="form-control" placeholder="Visitor Email"
                        readonly>
                    <input wire:model="visitor_phone" type="text" class="form-control" placeholder="Visitor Phone"
                        readonly>
                    ...
                    <div wire:loading class="text-sm text-muted mt-2">Booking appointment, please wait...</div>
        ...
        @if ($step === 1)
            <div class="fixed inset-0 z-50 flex items-center justify-center bg-transparent bg-opacity-80 backdrop-blur-sm"
                ...
                <div class="bg-gray-700 bg-opacity-95 px-6 py-4 rounded-lg shadow-xl w-full max-w-xl mx-4 text-white">
                    ...
                    <form wire:submit.prevent="searchVisitor" class="space-y-5 w-full">
                        <input wire:model="search_input" type="text" placeholder="Enter Phone, ID or Visitor UID"

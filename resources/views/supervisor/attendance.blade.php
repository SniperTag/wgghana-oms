                ...
                <div class="row">
                    ...
                    <div class="container-fluid">
                        <div class="d-flex justify-content-between align-items-center mb-4">
                            <h2 class="fw-bold font-san-serif font-extrabold fs-3xl">MY ATTENDANCE RECORDS</h2>
                        ...
                        <div class="mb-4 flex flex-wrap items-center justify-start gap-3 text-sm">
                            ...
                            <div class="dropdown">
                                ...
                                <ul class="dropdown-menu shadow" aria-labelledby="clockActionDropdown">
                                    ...
                                    <li>
                                        <button class="dropdown-item text-danger" id="clockOutSubmitBtn" onclick="openClockOutModal('{{ $staff->scheduled_clock_out ?? '17:30' }}')">
